    ...
    >
      <Popover className="relative h-full">
        <PopoverButton className="h-full">
          ...
          >
            <div className="absolute -right-1 bottom-8 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-[#720317] text-[10px] font-[500] text-white">
              {totalItems}
            </div>
        ...
        >
          <PopoverPanel
            static
            className="absolute right-0 top-[calc(100%+1px)] hidden w-[460px] rounded-b-lg border-x border-b border-gray-200 bg-white text-ui-fg-base small:block"
            data-testid="nav-cart-dropdown"
          >
            <div className="flex items-center justify-center p-4">
              <h3 className="text-large-semi font-gilroy">КОРЗИНА</h3>
            </div>
                ...
                <div className="flex flex-col items-center justify-center gap-y-4 py-16">
                  ...
                  <div>
                    <LocalizedClientLink href="/store">
                      <>
                        <span className="sr-only">На страницу всех товаров</span>
